...
import Sym from 'C:/Users/rauna/OneDrive/Desktop/Projects/Ram_Portfolio/src/assets/Sym.jpg'
import std from 'C:/Users/rauna/OneDrive/Desktop/Projects/Ram_Portfolio/src/assets/std.jpg'
import power from 'C:/Users/rauna/OneDrive/Desktop/Projects/Ram_Portfolio/src/assets/power.jpg'
import news from 'C:/Users/rauna/OneDrive/Desktop/Projects/Ram_Portfolio/src/assets/news.jpg'
import fake from 'C:/Users/rauna/OneDrive/Desktop/Projects/Ram_Portfolio/src/assets/fake.jpg'
    ...
    return (
        <div className="max-w-sm sm:max-w-sm md:max-w-sm bg-gray-900 border border-neutral-100 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            {title=='SymptomIQ' && <a href="#">
                <img className="w-full rounded-t-lg h-auto object-cover " src={Sym} alt="" />
            </a>}
            {title=='Deep Fake Detector' && <a href="#">
                <img className="w-full rounded-t-lg h-auto object-cover " src={fake} alt="" />
            </a>}
            {title=='Fake News Detection (NLP Project)' && <a href="#">
                <img className="w-full rounded-t-lg h-auto object-cover " src={news} alt="" />
            </a>}
            ...
            {title=='Student Management System' && <a href="#">
                <img className="w-full rounded-t-lg h-auto object-cover " src={std} alt="" />
            </a>}
